...
},{"./_tools":"ICalTools","./dayjs.min.js":"moment","./node_modules/dayjs/plugin/duration":5,"./node_modules/dayjs/plugin/utc":6}],"ICalAttendee":[function(require,module,exports){
'use strict';
...
},{"./_tools":"ICalTools","./dayjs.min.js":"moment","./event":"ICalEvent","./node_modules/dayjs/plugin/utc":6,"fs":1}],"ICalCategory":[function(require,module,exports){
'use strict';
...
class ICalEvent {
    ...
    recurrenceId (recurrenceId) {
        ...
        else if (!moment.isDayjs(recurrenceId)) {
    ...
    repeating (repeating) {
        ...
        if (repeating.exclude) {
            ...
            exclude.forEach(function (excludedDate, i) {
                ...
                else if (!moment.isDayjs(excludedDate)) {
    ...
    created (created) {
        ...
        if (!moment.isDayjs(created) || !created.isValid()) {
    ...
    lastModified (lastModified) {
        ...
        if (!moment.isDayjs(lastModified) || !lastModified.isValid()) {
...
},{"./_tools":"ICalTools","./alarm":"ICalAlarm","./attendee":"ICalAttendee","./category":"ICalCategory","./dayjs.min.js":"moment","./node_modules/dayjs/plugin/utc":6}],"ICalTools":[function(require,module,exports){
(function (Buffer){(function (){
'use strict';
...
},{"./dayjs.min.js":"moment","./node_modules/dayjs/plugin/utc":6,"buffer":3}],"moment":[function(require,module,exports){
